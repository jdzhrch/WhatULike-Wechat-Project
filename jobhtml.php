...
<script src="md5.js"></script> 
	<meta charset="UTF-8">
	<title>在你眼中，<?php echo "$realname" ?>真正热爱的是什么</title>
	<style type="text/css">
...
<body>
	<div class="wrapper">
		<div class="container">
			<h2>在您看来，<?php echo "$realname" ?>真正想要的，真正热爱的</h2>
			
			<form id="myForm" name='form' class="form" method='post' action='job.php' onSubmit="return check()">
				<input type="text" placeholder="工作/行业/爱好" name='jobname'>
				<input type="hidden" name='userid' value=<?php echo "$hisuserid" ?>>
